...
export const SEED_SOURCES: SeedSource[] = [
  ...
  },
  {
    ...
    verified: "live",
    notes:
      "ON PROBATION. Passive 5% stakes — mostly index funds rebalancing, which is not news. High volume, low signal. Kept only because the occasional 13G is a real accumulation. Revisit at CP4 with measured hit rate; this is the first source to cut if it does not earn its cost.",
  },
  {
  ...
  },
  {
    ...
    verified: "live",
    notes:
      "CONDITIONAL KEEP. Yahoo is a pure aggregator — it mostly republishes Reuters and AP, both of which are in this list but unreachable from the dev machine. It is here as a stand-in for them, nothing more. If Step 3 gets Reuters and AP working from the server, delete this entry: we would be paying to read the same stories twice, once at source and once secondhand.",
  },
  {
    name: "CNBC - Top News",
    kind: "rss",
